...
| loopforge_scaffold | pass | `Validated 7+ scaffolded specs in /tmp/loopforge-demo-82purm51` |
...
| integrate_langgraph_smoke | pass | `Level hint: L3 (pattern=multi-agent-coordination, workers=1, confidence=loopnet-v0.2) Wrote /tmp/integrate-lg-xwrnbn5o/l` |
| integrate_crewai_smoke | pass | `Level hint: L3 (pattern=multi-agent-coordination, workers=1, confidence=loopnet-v0.2) Wrote /tmp/integrate-crew-sism5gmx` |
...
_Generated at 2026-08-03T16:30:13.309381+00:00_

...
| loopforge_scaffold | pass | `Validated 7+ scaffolded specs in /tmp/loopforge-demo-m48kv_w5` |
...
| integrate_langgraph_smoke | pass | `Level hint: L3 (pattern=multi-agent-coordination, workers=1, confidence=loopnet-v0.2) Wrote /tmp/integrate-lg-6x_vfbmc/l` |
| integrate_crewai_smoke | pass | `Level hint: L3 (pattern=multi-agent-coordination, workers=1, confidence=loopnet-v0.2) Wrote /tmp/integrate-crew-sxzz66pd` |
...
_Generated at 2026-07-08T16:04:39.322960+00:00_

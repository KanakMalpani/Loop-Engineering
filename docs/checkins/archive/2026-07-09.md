...
| loopforge_scaffold | pass | `Validated 7+ scaffolded specs in /tmp/loopforge-demo-4v6ko5tx` |
...
| integrate_langgraph_smoke | pass | `Level hint: L3 (pattern=multi-agent-coordination, workers=1, confidence=loopnet-v0.2) Wrote /tmp/integrate-lg-9805u8u6/l` |
| integrate_crewai_smoke | pass | `Level hint: L3 (pattern=multi-agent-coordination, workers=1, confidence=loopnet-v0.2) Wrote /tmp/integrate-crew-xbxooep3` |
...
_Generated at 2026-07-09T16:30:37.291860+00:00_

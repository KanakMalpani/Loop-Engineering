...
| loopforge_scaffold | pass | `Validated 7+ scaffolded specs in /tmp/loopforge-demo-iv5o9l85` |
...
| integrate_langgraph_smoke | pass | `Level hint: L3 (pattern=multi-agent-coordination, workers=1, confidence=loopnet-v0.2) Wrote /tmp/integrate-lg-odgdeubn/l` |
| integrate_crewai_smoke | pass | `Level hint: L3 (pattern=multi-agent-coordination, workers=1, confidence=loopnet-v0.2) Wrote /tmp/integrate-crew-c3_vb8p5` |
...
_Generated at 2026-07-24T15:28:25.912551+00:00_

...
| combine_smoke | pass | `NOTE: refs smaller than flat ({'before': 609, 'after': 1827, 'saved': -1218, 'ratio': 3.0}); flat avoids multi-file refs` |
| minjson_smoke | pass | `OK minjson_smoke tokens=1143 min_ratio=0.3` |

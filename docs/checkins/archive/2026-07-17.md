...
| loopforge_scaffold | pass | `Validated 7+ scaffolded specs in /tmp/loopforge-demo-uvjms5h6` |
...
| integrate_langgraph_smoke | pass | `Level hint: L3 (pattern=multi-agent-coordination, workers=1, confidence=loopnet-v0.2) Wrote /tmp/integrate-lg-zdt8knny/l` |
| integrate_crewai_smoke | pass | `Level hint: L3 (pattern=multi-agent-coordination, workers=1, confidence=loopnet-v0.2) Wrote /tmp/integrate-crew-93pbr2k7` |
...
_Generated at 2026-07-17T15:17:36.024493+00:00_

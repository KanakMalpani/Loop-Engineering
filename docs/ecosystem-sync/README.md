# Ecosystem sync — local README mirrors

Edit these files, then push to sibling repos with [MAINTAINER-SYNC.md](../../contributions/MAINTAINER-SYNC.md).

| File | Remote target |
|------|---------------|
| [LoopBench-README.md](./LoopBench-README.md) | `KanakMalpani/LoopBench` README.md |
| [loopnet-README.md](./loopnet-README.md) | `KanakMalpani/loopnet` README.md |
| [LoopGym-README.md](./LoopGym-README.md) | `KanakMalpani/LoopGym` README.md |
...
| [loopnet/.github/workflows/](./loopnet/.github/workflows/hf-dataset-upload.yml) | HF dataset upload on `loopnet-v*` tags |
